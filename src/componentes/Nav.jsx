      ...
      <div className='contenido-nav'>
        <div className='contenedor-logo'>
          <div className='contenedor-logo-boton'>
            <div className='nav-logo'>  
              <svg color="#262626"fill="#262626"height="29"role="img"viewBox="32 4 113 32" width="103">              
            ...
            <button className='nav-boton-logo'>
            <svg color="#262626"fill="#262626" height="12" width="12" role="img" viewBox="0 0 24 24">            
        ...
        <div className='contenedor-buscar'>
          <div className='buscar'>
            <input className='input-buscar' placeholder=''></input>
            <div className='buscar-lupita'>
              <div className='contenedor-lupita'>
                <div className='lupita'>
                  <svg aria-label="Busca" color="#8e8e8e" fill="#8e8e8e" height="16" role="img" viewBox="0 0 24 24" width="16">
        ...
        <div className='contenedor-navBotones'>
          <div className='contenido-navBotones'>
            <NavBoton
            ...
            />
            <NavBoton 
              svg={<span className='perfil'></span>}
            />
          </div>
        </div>   
      </div>      
